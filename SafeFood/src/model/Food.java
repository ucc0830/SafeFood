...
public class Food {
	...
	public Food(int code, String name, double supportpereat, double calory, double carbo, double protein, double fat,
			double sugar, double natrium, double chole, double fattyacid, double transfat, int bgnYear, String maker,
			String material, String img, String allergy, String category) {
		super();
		this.code = code;
		this.name = name;
	...
	public Food(int code, String name, double supportpereat, double calory, double carbo, double protein, double fat,
			double sugar, double natrium, double chole, double fattyacid, double transfat, int bgnYear, String maker,
			String material, String img,String aller) {
		super();
		this.code = code;
		this.name = name;
		this.supportpereat = supportpereat;
	...
	public Food(Food fd) {
		...
		this.supportpereat = fd.getSupportpereat();
		this.calory = fd.getCalory();
		this.carbo = fd.getCarbo();
		this.protein = fd.getProtein();
		this.fat = fd.getFat();
		this.sugar = fd.getSugar();
		this.natrium = fd.getNatrium();
		this.chole = fd.getChole();
		this.fattyacid = fd.getFattyacid();
		this.transfat = fd.getTransfat();
		this.bgnYear = fd.getBgnYear();
		this.maker = fd.getMaker();
		this.material = fd.getMaterial();
		this.img = fd.getImg();
	}
	public int getCode() {
		return code;
	...
	public int getBgnYear() {
		return bgnYear;
	}
	public void setBgnYear(int bgnYear) {
		this.bgnYear = bgnYear;
	}
	@Override
